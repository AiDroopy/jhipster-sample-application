package se.blekingeindustri.sample.service;
...
import se.blekingeindustri.sample.IntegrationTest;
import se.blekingeindustri.sample.config.Constants;
import se.blekingeindustri.sample.domain.User;
import se.blekingeindustri.sample.repository.UserRepository;
import se.blekingeindustri.sample.repository.search.UserSearchRepository;
import se.blekingeindustri.sample.security.AuthoritiesConstants;
import se.blekingeindustri.sample.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the se.blekingeindustri.sample.repository.search test package.
     *
     * @see se.blekingeindustri.sample.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
